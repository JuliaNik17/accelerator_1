...
var phoneInput = document.querySelector('.phone-number'); // const PHONE_NUMBER_LENGTH = 11;

var overlay = document.querySelector('.overlay');
var overlayImg = document.querySelector('.overlay__img');
...
phoneInput.addEventListener('input', function () {
  var phoneValue = parseInt(phoneInput.value, 10);
